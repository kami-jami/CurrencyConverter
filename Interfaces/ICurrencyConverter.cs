namespace CurrencyConverter.Interfaces
{
    public interface ICurrencyConverter
    {
        ...
        /// </summary> void ClearConfiguration();
        void ClearConfiguration();

        /// <summary> 
        /// Updates the configuration. Rates are inserted or replaced internally. 
        /// </summary> void UpdateConfiguration(IEnumerable<Tuple<string, string, double>> conversionRates); 
        ...
        /// </summary> double Convert(string fromCurrency, string toCurrency, double amount);
